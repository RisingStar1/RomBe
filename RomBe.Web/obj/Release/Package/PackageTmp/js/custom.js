/// <reference path="C:\Users\Almog\Documents\Visual Studio 2013\Projects\RomBe\RomBe.Web\index.html" />
/* =================================
   LOADER                     
=================================== */
...
function SubscriptionCallback(resp) {
    if (resp.IsSent) {
        $('.subscription-success').html('<i class="icon_check_alt2"></i><br/>' + resp.Message).fadeIn(1000);
        $('.subscription-error').fadeOut(500);

    } else {
        $('.subscription-error').html('<i class="icon_close_alt2"></i><br/>' + resp.Message).fadeIn(1000);
    }
}
